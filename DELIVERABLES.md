...
This file maps the assignment requirements to files and features implemented in this repository.
...
- Task 1: Project Setup & Infrastructure Foundation
  ...
  - Variables and validation rules: `variables.tf`, `modules/*/variables.tf`
...
- Task 2: Serverless API with Lambda & API Gateway
  ...
  - API Gateway REST API with proxy integration and CORS: `modules/api-gateway/*`
  - DynamoDB integration (client present, mocked responses): `functions/items-api/index.js`
